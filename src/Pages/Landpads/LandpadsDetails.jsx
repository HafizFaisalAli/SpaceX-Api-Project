...
import { HookForLandpadsDetails } from "../../Hooks/HookForPage";

const LandpadsDetails = () => {

  const {id} = useParams();
  const {data, error, loading} = HookForLandpadsDetails(id) ;
...
export default LandpadsDetails 
